...
{   
   ...
   const PinName& PIN_DISPLAY_GRAPHIC_CS = p11;
   const PinName& PIN_DISPLAY_GRAPHIC_RESET = p12;
   const PinName& PIN_DISPLAY_GRAPHIC_DATA_SELECT = p13;
   ...
   const PinName& PIN_LIGHTS_HEADLIGHTS_INPUT = p22;

   const PinName& PIN_LIGHTS_HEADLIGHTS = p23;
...
, dashboard_(PIN_DISPLAY_MOSI,
             ...
             PIN_DISPLAY_CLOCK,
             PIN_DISPLAY_CHAR_CS, 
             PIN_DISPLAY_GRAPHIC_CS,
             PIN_DISPLAY_GRAPHIC_DATA_SELECT,
             PIN_DISPLAY_GRAPHIC_RESET, 
             vehicleData_)
